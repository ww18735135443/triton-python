...
class Colors:
    ...
    def __init__(self):
        ...
        self.color_palette = np.array([[255, 128, 0], [255, 153, 51], [255, 178, 102], [230, 230, 0], [255, 153, 255],
...
def draw_detections(img, detections,label_color=None,show_conf=False):
    """
    ...
    # for box, score, class_id in zip(bboxs, scores, class_ids):
        ...
        if label_color is not None:
            ...
            color = colors.color_palette[class_id].tolist()
        else:
             color=[205,50,50]
    ...
    # return img
def draw_detections_boxonly(img, detections,label_color=None):
    """
    Draws bounding boxes and labels on the input image based on the detected objects.
